...
function handleNumberClick(number) {
  ...
  // HINT: remember, the number and display variables are strings so they will not evaluate like numbers but just be concaternated (added end to end) just like we want
  // Numbers:1+1=2
  // Strings:"1"+"1"="11"
  display += number;
}
...
function handleEqualsClick() {
  ...
  if (operand == "ADD") {
    display = parseFloat(memory) + parseFloat(display);
...
//---TODO---
//----------
// write the subtract, multiply and divide functions from scratch
